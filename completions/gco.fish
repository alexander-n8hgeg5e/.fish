...
complete -k -f -c gco -n 'not contains -- -- (commandline -op)' -a '(__fish_git_branches)'
complete -k -f -c gco -n 'not contains -- -- (commandline -op)' -a '(__fish_git_heads)' -d 'Head'
complete -k -f -c gco -n 'not contains -- -- (commandline -op)' -a '(__fish_git_tags)' -d 'Tag'
complete -k -f -c gco -n 'not contains -- -- (commandline -op)' -a '(__fish_git_unique_remote_branches)' -d 'Unique Remote Branch'
complete -k -f -c gco -a '(__fish_git_files modified deleted)'
